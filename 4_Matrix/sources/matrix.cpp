...
matrix_t::matrix_t(const matrix_t& rhs) : colons(new int[rhs.rank]), data(new double* [rhs.rank]), rank(rhs.rank), size(rhs.size) {
...
row_t::row_t(const row_t& rhs) : rank(rhs.rank), data(new double[rhs.rank]) {
